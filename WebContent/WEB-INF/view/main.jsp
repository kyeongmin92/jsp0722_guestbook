...
<body class="bg-light">
			...
			<div class="media border p-3">
				...
				<div class="media-body">
					...
					<a data-toggle="modal" href="#exampleModal"
						data-message-id="${message.id }" class="btn-delete btn-danger">삭제하기</a>
					<%-- <button data-message-id="${message.id }"
						class="btn btn-danger btn-delete">삭제하기</button> --%>
				</div>
			</div>
		</c:forEach>
	</div>
	...
	<!-- <div class="container delete-form">
		<form action="delete" method="post">
			message_id: <input id="delete-input-id" type="text" name="id"
				value="" /> <br /> 암호 : <input type="password" name="password" /><br />
      ...
      <div class="modal-body">
        ...
        <input type="text" class="d-none form-control" name="id"
          ...
          <div class="form-group">
            ...
            <input type="text" name="password" class="form-control" id="message-text">
          </div>          
        </form>
      </div>
